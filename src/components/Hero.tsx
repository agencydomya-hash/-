        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-sm font-medium"
            >
            ...
            <motion.p
              ...
              className="text-gray-300 text-lg sm:text-xl font-sans leading-relaxed max-w-2xl"
            >
              المرضى لا يبحثون فقط عن طبيب، بل يبحثون عن مصدر ثقة وأمان. في وكالة 
              <span className="text-white font-semibold"> دومايا</span>، ندمج عالم الطب بالتسويق الإبداعي لنبني لك هويتك الرقمية المتكاملة من داخل عيادتك.
            </motion.p>
            ...
            >
              ...
              <button
                ...
                className="px-8 py-4 bg-transparent hover:bg-white/5 text-white font-semibold rounded-xl border-2 border-white/20 hover:border-white/40 transition duration-300 flex items-center justify-center gap-2 text-lg"
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs sm:text-sm text-gray-400 mt-1">محتوى علمي دقيق وجذاب</div>
              </div>
            </motion.div>
          </div>

          {/* Interactive Clinical Prescripton Sheet Card */}
