...
export default function BookingForm({ diagnosisRef, onSuccess }: BookingFormProps) {
  ...
  return (
    <div className="bg-transparent py-20 border-b border-white/5 relative z-10" id="booking-section">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        {submitted ? (
          /* Submission Receipt Box (Glassmorphic) */
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="glass border border-emerald-500/20 p-8 sm:p-10 rounded-3xl text-center space-y-6 text-white shadow-xl"
            id="booking-success"
            dir="rtl"
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-300 text-sm max-w-md mx-auto">
                شكراً دكتور <span className="font-bold text-[#FF5100]">{form.name}</span>. تم استلام ملفك وتحويله للجنة الفنية بوكالة دومايا لفحصه ومراجعته.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white/5 p-4 rounded-xl border border-emerald-500/20 text-right text-xs max-w-lg mx-auto">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <span className="font-bold text-emerald-400">سرية بيانات الطبيب مضمونة 🔒</span>
                </div>
              </div>
            </div>

            {/* Email Confirmation Notice */}
            <div className="bg-[#091B65]/20 border border-[#091B65]/35 p-4 rounded-xl text-right space-y-2 max-w-lg mx-auto">
          ...
          <motion.div
            ...
            className="glass rounded-[32px] shadow-2xl p-8 sm:p-12 text-white relative overflow-hidden"
          ...
          >
            ...
            {diagnosisRef && (
              <div className="mb-6 p-4 bg-[#FF5100]/10 border border-[#FF5100]/25 text-orange-400 rounded-xl text-xs sm:text-sm font-semibold flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">
                    اسم الطبيب الكريم <span className="text-[#FF5100]">*</span>
                  </label>
                  <input
                    type="text"
                    name="name"
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 focus:ring-2 focus:ring-[#FF5100] focus:border-[#FF5100] outline-none text-white text-sm placeholder-slate-450 focus:bg-white/10 transition duration-200"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">
                    التخصص الدقيق <span className="text-[#FF5100]">*</span>
                  </label>
                  <input
                    type="text"
                    name="specialty"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">اسم العيادة أو المركز الطبي</label>
                  <input
                    type="text"
                    name="clinicName"
                ...
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">
                    رقم الهاتف للاتصال والواتساب <span className="text-[#FF5100]">*</span>
                  </label>
                  <div className="relative">
                    <input
                      ...
                      value={form.phone}
                      onChange={handleInputChange}
                      className="w-full px-10 py-3 rounded-xl border border-white/10 bg-white/5 focus:ring-2 focus:ring-[#FF5100] focus:border-[#FF5100] outline-none text-white text-sm text-left placeholder-slate-450 focus:bg-white/10 transition duration-200"
                      dir="ltr"
                    />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Email Address */}
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">البريد الإلكتروني</label>
                  <div className="relative">
                    <input
                      type="email"
                      name="email"
                ...
                {/* Current Social Link */}
                <div className="space-y-2">
                  <label className="block text-xs sm:text-sm font-bold text-slate-300">رابط صفحتك الحالية إن وجد</label>
                  <div className="relative">
                    <input
                      type="url"
                      name="socialLink"
              ...
              <div className="space-y-2">
                <label className="block text-xs sm:text-sm font-bold text-slate-300">الهدف الأبرز للبراندينج وعيادتك</label>
                <div className="relative">
                  <select
                    name="goal"
                    value={form.goal}
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 rounded-xl border border-white/10 bg-[#050B24] focus:ring-2 focus:ring-[#FF5100] focus:border-[#FF5100] outline-none text-white text-sm appearance-none font-medium transition focus:bg-[#091B65]"
                  >
                    <option value="جذب مرضى حقيقيين وزيادة تعاقدات العيادة" className="bg-[#050B24] text-white">جذب مرضى حقيقيين وزيادة حجوزات العيادة 📈</option>
                    <option value="تثبيت الهيبة والمصداقية العلمية ومواجهة المنافسين" className="bg-[#050B24] text-white">تثبيت المصداقية العلمية ومواجهة المنافسين 🛡️</option>
                    <option value="بناء براند متكامل وتصوير Reels احترافي بالعيادة" className="bg-[#050B24] text-white">بناء براند متكامل وتصوير Reels احترافي بالعيادة 🎥</option>
                    <option value="توسيع الانتشار والوصول لصفحات التلفزيون أو السفر الطبي" className="bg-[#050B24] text-white">توسيع الانتشار والوصول للظهور الإعلامي المتميز 🌟</option>
                    <option value="بناء البراند الطبي الموصى به في الروشتة الذكية" className="bg-[#050B24] text-white">بناء البراند الطبي الموصى به في الروشتة الذكية 📝</option>
                  </select>
              ...
              <div className="pt-4 text-left">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full sm:w-auto px-10 py-4 bg-[#FF5100] hover:bg-orange-650 text-white font-bold rounded-xl transition duration-300 shadow-xl shadow-orange-500/25 flex items-center justify-center gap-2 text-base cursor-pointer"
